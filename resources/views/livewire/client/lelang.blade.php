<div>
    ...
    <div class="card border-none">
        <div class="container">
            <button class="btn bg-blue my-3" wire:click="create()" style="width: 100%"><span class="text-white"><i class="fas fa-plus"></i>&nbsp;&nbsp;Buat Lelang</span></button>
        </div>
    </div>
    <div class="card border-none mt-4 pt-3">
        <div class="container">
            @foreach ($data as $item)
            <a href="{{ route('client.lelang.action',$item->id) }}">
                <div class="card mb-3 border-none shadow" style="max-width: 540px;">
                    <div class="row no-gutters">
                    <div class="col-md-4">
                        <div class="bg-img-card" style="background-image: url('{{ asset('storage/lelang/'.$item->image) }}')">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 text-truncate">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-6 text-right">30 Hari lagi</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
